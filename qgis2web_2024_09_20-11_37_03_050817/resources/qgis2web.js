...
map.getView().fit([11257380.094189, 508072.536992, 11257834.555615, 508354.993397], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">UntitledCloudProject (QFieldCloud)</h2>';
        return titleElement;
    })(),
